		...
		<div className="min-h-screen w-full flex items-center justify-center bg-gray-50 px-4">
			...
			<div className="w-full max-w-md bg-white border border-gray-200 p-8 shadow-sm flex flex-col justify-between min-h-[550px]">
				...
				<div className="text-center space-y-2.5">
					...
					{/* (title) */}
					<h1 className="text-xl font-black tracking-tight text-[#222222] uppercase">
						Cash Apply
					</h1>
					{/* (catchphrase) */}
				...
				<form onSubmit={handleSubmit} className="space-y-4 my-auto pt-4">
					...
					<div className="space-y-1">
						...
						<div className="relative">
							...
							<input
								...
								disabled={isLoading}
								className="w-full bg-white border border-gray-300 focus:border-[#222222] pl-9 pr-3 py-2 text-xs font-medium text-gray-900 placeholder-gray-400 focus:outline-none transition-colors disabled:opacity-60"
							/>
						</div>
					</div>
					...
					<button
						type="submit"
						disabled={isLoading}
						className="w-full flex items-center justify-center gap-2 bg-[#222222] hover:bg-[#222222] text-white py-2.5 font-bold text-xs uppercase tracking-widest transition-all shadow-sm group disabled:opacity-50 mt-2"
					>
