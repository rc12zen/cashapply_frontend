  ...
  return (
    <>
      ...
      {runCompletionSummary && (
        <div className="bg-[#222222] text-white px-5 py-4 shadow-sm border border-[#000000] flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
