      ...
      <div className="bg-white border border-gray-200 p-6 shadow-xs flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-1 bg-gray-100 p-1 rounded-sm self-start sm:self-auto shrink-0">
          <button
            ...
            className={`px-3 py-1.5 text-[10px] font-bold uppercase tracking-wider rounded-xs transition-all cursor-pointer ${viewMode === "posted" ? "bg-[#222222] text-white shadow-xs" : "text-gray-500 hover:text-primary"}`}
          >
            Invoice Mapped Records
          </button>
          <button
            onClick={() => setViewMode("non_posted")}
            className={`flex items-center gap-1.5 px-3 py-1.5 text-[10px] font-bold uppercase tracking-wider rounded-xs transition-all cursor-pointer ${viewMode === "non_posted" ? "bg-[#222222] text-white shadow-xs" : "text-gray-500 hover:text-primary"}`}
          >
          ...
          <div className="flex items-center gap-2">
            ...
            {viewMode === "posted" && (
              <button
                ...
                disabled={exporting}
                className="flex items-center gap-1.5 bg-[#222222] hover:bg-[#000000] text-white px-4 py-2 text-[10px] font-black uppercase tracking-wider rounded-sm transition-colors cursor-pointer disabled:opacity-50"
              >
                  ...
                  return (
                    <button
                      ...
                      className={`flex items-center gap-2 px-3 py-2 rounded-full border text-xs font-bold transition-all shadow-xs cursor-pointer ${
                        active ? "bg-[#222222] text-white border-[#222222]" : "border-gray-200 bg-white text-gray-600 hover:border-gray-300"
                      }`}
                    >
