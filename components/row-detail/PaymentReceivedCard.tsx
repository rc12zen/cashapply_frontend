...
export default function PaymentReceivedCard({ recordId, bs }: { recordId: number; bs: RowDetail["bank_statement"] }) {
  return (
    <CardShell>
          ...
          <DataRow
            ...
            value={
              <RevealableAccountNumber
                masked={bs.bank_account_number}
                fetchFull={() => revealLineItemAccountNumber(recordId)}
              />
            }
          />
