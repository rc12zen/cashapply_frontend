			...
			<div className="grid grid-cols-1 sm:grid-cols-4 gap-3 bg-white border border-gray-200 p-4 rounded-sm shadow-2xs">
				<div className="relative flex items-center">
					...
					<select
						...
						className="w-full bg-gray-50 border border-gray-300 rounded-sm text-xs font-bold text-primary pl-9 pr-3 py-2 outline-none focus:border-[#222222] cursor-pointer"
					>
				...
				<div className="relative flex items-center">
					...
					<input
						...
						className="w-full bg-gray-50 border border-gray-300 rounded-sm text-xs font-bold text-primary pl-20 pr-3 py-2 outline-none focus:border-[#222222]"
					/>
				</div>
				...
				<div className="relative flex items-center">
					...
					<input
						...
						className="w-full bg-gray-50 border border-gray-300 rounded-sm text-xs font-bold text-primary pl-9 pr-3 py-2 outline-none focus:border-[#222222]"
					/>
				</div>
			</div>
