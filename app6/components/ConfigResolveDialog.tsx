  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-gray-900/60 backdrop-blur-sm p-4">
      <div className="bg-white w-full max-w-2xl max-h-[85vh] flex flex-col rounded shadow-xl overflow-hidden">
        <div className="bg-[#222222] text-white px-5 py-3 flex items-center justify-between shrink-0">
          <div className="flex items-center gap-2 min-w-0">
            <FileText size={15} className="text-[#222222] shrink-0" />
              ...
              <div key={c.config_key} className="border border-gray-200 rounded p-3 space-y-2">
                <div className="flex items-center justify-between gap-2">
                  ...
                  <button onClick={() => runTest(c)} disabled={t?.loading}
                    className="flex items-center gap-1 text-[10px] font-black uppercase tracking-wide border border-gray-300 text-gray-600 hover:border-[#222222] hover:text-[#222222] px-2.5 py-1.5 rounded-sm cursor-pointer disabled:opacity-50">
        ...
        <div className="border-t border-gray-200 px-5 py-3 flex items-center justify-between shrink-0">
          ...
          <button onClick={onBuildNew} className="flex items-center gap-1.5 text-xs font-bold text-[#222222] hover:underline cursor-pointer">
